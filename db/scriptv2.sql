...
--
-- Host: icase-store-database-vquispealarcon-649a.e.aivencloud.com    Database: db_icase_seminario
-- ------------------------------------------------------
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  /*!50003 TRIGGER `before_insert_cliente` BEFORE INSERT ON `tb_cliente` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  /*!50003 TRIGGER `actualizar_metricas_proveedor` AFTER INSERT ON `tb_compra` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  /*!50003 TRIGGER `actualizar_fecha_compra` AFTER INSERT ON `tb_compra` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  /*!50003 TRIGGER `after_purchase_update_kardex` AFTER INSERT ON `tb_detalle_compra` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  /*!50003 TRIGGER `after_sale_detail_insert` AFTER INSERT ON `tb_detalle_venta` FOR EACH ROW BEGIN
    DECLARE v_stock_actual INT;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  /*!50003 TRIGGER `before_producto_insert` BEFORE INSERT ON `tb_productos` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  /*!50003 TRIGGER `actualizar_cliente_after_insert` AFTER INSERT ON `tb_ventas` FOR EACH ROW BEGIN
